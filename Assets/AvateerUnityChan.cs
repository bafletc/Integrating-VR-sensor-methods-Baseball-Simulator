...
public class AvateerUnityChan : MonoBehaviour {
                ...
                if (frame != null)
                {
                    ...
                    else if (users.Length > 0)
                    {
                        ...
                        for (int index = 0; index < models.Length; index++)
                        {
                            ...
                            bat1.transform.position = model.GetBone(JointType.WristRight).Transform.position;
                            bat.transform.position = model.GetBone(JointType.Neck).Transform.position;
                    ...
                    //frameView.SetPositionOnFrame(ref position2D);
