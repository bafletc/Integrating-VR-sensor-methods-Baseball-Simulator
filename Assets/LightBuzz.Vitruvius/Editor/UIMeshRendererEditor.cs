...
namespace LightBuzz.Vitruvius
{
    ...
    public class UIMeshRendererEditor : Editor
    {
        new MeshRenderer[] targets = null;
        ...
        void OnEnable()
        {
            ...
            targets = new MeshRenderer[objectTargets.Length];

            for (int i = 0; i < objectTargets.Length; i++)
            {
                targets[i] = (MeshRenderer)objectTargets[i];
        ...
        public override void OnInspectorGUI()
        {
            ...
            Undo.RecordObjects(targets, "Undo MeshSortingLayer");
